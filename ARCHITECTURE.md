...
Все данные хранятся в директории `/datastore` на хосте:
...
Это позволяет:
- Делать бэкапы без остановки контейнеров
- Легко мигрировать данные между серверами
- Управлять дисковым пространством на уровне ОС
- Мониторить использование диска стандартными инструментами
